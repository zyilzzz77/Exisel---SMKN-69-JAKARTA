...
## Components
- **Buttons:** Large, 4px black border, 4px hard shadow. Text must be Bold. Primary buttons use Electric Blue; Secondary buttons use White or Bright Orang

ields:** 3px black border, White background. On focus, the background changes to Light Blue or the border thickens to 5px.
